...
texto = "The clock struck twelve."
print(type(texto))


# 3. Crie uma variável chamada "booleano" e atribua a ela um valor booleano ("True" ou "False").
# Verifique o tipo de dado dessa variável usando "type".

booleano = True
print(type(booleano))

# 4. Crie uma variável chamada "nulo" e atribua a ela o valor nulo ("None"). Verifique o tipo de dado
# dessa variável usando "type".
